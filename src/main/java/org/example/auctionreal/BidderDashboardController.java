...
public class BidderDashboardController {
     ...
     * Được gọi trong initialize() trước khi hiển thị danh sách.
     */
     ...
     * Được dùng bởi refreshItemList() và handleSearch().
     */
     ...
     * Được gọi sau loadDemoItems() và khi chuyển trang.
     */
    ...
    /** Làm mới các ô thống kê nhanh (số lượng vật phẩm, live, sắp kết thúc...). */
     ...
     * Được gọi bởi handleItemSelected().
     */
    ...
    public void initialize() {
        ...
        // Load dữ liệu demo rồi hiển thị
        loadDemoItems();
        refreshItemList();
        refreshStats();
    }
